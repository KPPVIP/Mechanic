...
function StopNPCJob(cancel)
	...
	if cancel then
		...
		--TriggerServerEvent('polo_mecanojob:onNPCJobCompleted')
	end
end
      ...
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            if Config.EnablePlayerManagement and PlayerData.job ~= nil and
              (PlayerData.job.grade_name == 'boss' or PlayerData.job.grade_name == 'experimente') then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'gaz_bottle' then
          menu.close()
          TriggerServerEvent('polo_mecanojob:startHarvest')
        end

        if data.current.value == 'fix_tool' then
          menu.close()
          TriggerServerEvent('polo_mecanojob:startHarvest2')
        end

        if data.current.value == 'caro_tool' then
          menu.close()
          TriggerServerEvent('polo_mecanojob:startHarvest3')
        end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'blow_pipe' then
          menu.close()
          TriggerServerEvent('polo_mecanojob:startCraft')
        end

        if data.current.value == 'fix_kit' then
          menu.close()
          TriggerServerEvent('polo_mecanojob:startCraft2')
        end

        if data.current.value == 'caro_kit' then
          menu.close()
          TriggerServerEvent('polo_mecanojob:startCraft3')
        end
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('polo_mecanojob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('polo_mecanojob:getStockItem', itemName, count)
            end
...
ESX.TriggerServerCallback('polo_mecanojob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('polo_mecanojob:putStockItems', itemName, count)
            end
...
RegisterNetEvent('polo_mecanojob:dep')
AddEventHandler('polo_mecanojob:dep', function()
        local playerped = GetPlayerPed(-1)
          ...
          if CurrentlyTowedVehicle == nil then
            if targetVehicle ~= 0 then
              if not IsPedInAnyVehicle(playerped, true) then
                if vehicle ~= targetVehicle then
                  AttachEntityToEntity(targetVehicle, vehicle, 20, -0.6, -5.0, 0.8, 0.0, 0.0, 0.0, false, false, false, false, 20, true)
            ...
            if NPCOnJob then
              ...
              if CurrentlyTowedVehicle == NPCTargetTowable then
                ...
                TriggerServerEvent('polo_mecanojob:onNPCJobMissionCompleted')
                StopNPCJob()
...
RegisterNetEvent('polo_mecanojob:del')
AddEventHandler('polo_mecanojob:del', function()
...
RegisterNetEvent('polo_mecanojob:menubills')
AddEventHandler('polo_mecanojob:menubills', function()
	OuvrirMenuFacture()
end)
function OuvrirMenuFacture() -- A FINIR LES FACTURE 
	local nombre = KeyboardInput1("Polo", "Facture :", "", 8)
...
RegisterNetEvent('polo_mecanojob:clean')
AddEventHandler('polo_mecanojob:clean', function()
        local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('polo_mecanojob:repair')
AddEventHandler('polo_mecanojob:repair', function()
        local playerPed = GetPlayerPed(-1)
        local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('polo_mecanojob:onHijack')
AddEventHandler('polo_mecanojob:onHijack', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('polo_mecanojob:onCarokit')
AddEventHandler('polo_mecanojob:onCarokit', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
RegisterNetEvent('polo_mecanojob:onFixkit')
AddEventHandler('polo_mecanojob:onFixkit', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
AddEventHandler('polo_mecanojob:hasEnteredMarker', function(zone)
...
AddEventHandler('polo_mecanojob:hasExitedMarker', function(zone)

  if zone == 'Craft' then
    TriggerServerEvent('polo_mecanojob:stopCraft')
    TriggerServerEvent('polo_mecanojob:stopCraft2')
    TriggerServerEvent('polo_mecanojob:stopCraft3')
  end

  if zone == 'Harvest' then
    TriggerServerEvent('polo_mecanojob:stopHarvest')
    TriggerServerEvent('polo_mecanojob:stopHarvest2')
    TriggerServerEvent('polo_mecanojob:stopHarvest3')
  end
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
      ...
      if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
        ...
        TriggerEvent('polo_mecanojob:hasEnteredMarker', currentZone)
      end
      if not isInMarker and HasAlreadyEnteredMarker then
        HasAlreadyEnteredMarker = false
        TriggerEvent('polo_mecanojob:hasExitedMarker', LastZone)
      end
    end
  end
end)
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsControlJustReleased(0, Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'mecano' then
            TriggerEvent('menuv_mecano:menuv_menuf6')
        end
